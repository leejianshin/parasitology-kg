...
const pairs = [
  ...
  ["normalized-request-schema-candidate.yml", "normalized-request-diagnostic-role-catalog-positive.json"],
  ...
  ["clause-ast-schema-candidate.yml", "clause-ast-diagnostic-role-catalog-positive.json"],
  ...
  ["event-frame-schema-candidate.yml", "event-frame-diagnostic-role-catalog-positive.json"],
  ...
  ["stage-semantic-validation-result-schema-candidate.yml", "stage-validation-s2-diagnostic-role-catalog-positive.json"],
  ["https://example.invalid/parasitology-kg/phase9/request-schema.yml", "request-shared-argument-positive.json"],
  ["https://example.invalid/parasitology-kg/phase9/request-schema.yml", "request-diagnostic-role-catalog-positive.json"],
