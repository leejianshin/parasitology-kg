...
2026-07-25，用户提供第10版教材印刷页码92–97的连续页图。人工核验确认：

- 第93页为“第二节｜华支睾吸虫”起始页；
- 第94–97页为连续专节正文；
- 第97页在防治条目后以“（吴翔）”署名收束。

因此，第10版专节范围由`provisional_start_page_only`升级为
`reviewed: printed_pages 93–97`。这只解除来源范围阻塞，不改变本审计对
v3十条命题的原子性、题库定位、证据角色和循环证据判定。详细核验记录见
`reviews/clonorchis-sinensis/pmph-10e-page-scope-verification.md`。
